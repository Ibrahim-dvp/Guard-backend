...
class UpdateLeadRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'client_first_name'  => ['sometimes', 'string', 'max:100'],
            'client_last_name'   => ['sometimes', 'string', 'max:100'],
            ...
            'status'             => ['sometimes', 'in:new,assigned,contacted,qualified,proposal,negotiation,won,lost,cancelled'],
